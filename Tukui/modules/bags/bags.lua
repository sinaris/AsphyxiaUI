...
function Stuffing:CreateBagFrame( w )
	...
	f.b_close.t:SetFont( C["media"].pixelfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE" )
...
function Stuffing:PLAYER_ENTERING_WORLD()
	...
	if( S.toc >= 40200 ) then return end
	...
	ContainerFrame1.ClearAllPoints = S.dummy
	ContainerFrame1.SetPoint = S.dummy
end
