...
S.MicroMenu = {
	...
	{ text = RAID,
	func = function() if( S.toc >= 40300 ) then ToggleFrame( RaidParentFrame ) else ToggleFriendsFrame( 4 ) end end },
	{ text = HELP_BUTTON,
	...
	func = function() if( S.toc >= 40200 ) then if( S.toc >= 40300 ) then ToggleEncounterJournal() else ToggleFrame( EncounterJournal ) end end end },
}
