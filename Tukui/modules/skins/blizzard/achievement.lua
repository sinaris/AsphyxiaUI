...
local function LoadSkin()
	...
	S.SkinCloseButton( AchievementFrameCloseButton, AchievementFrame.backdrop )
	S.SkinDropDownBox( AchievementFrameFilterDropDown )
	AchievementFrameFilterDropDown:Point( "TOPRIGHT", AchievementFrame, "TOPRIGHT", -44, 5 )

	S.SkinScrollBar( AchievementFrameCategoriesContainerScrollBar )
	S.SkinScrollBar( AchievementFrameAchievementsContainerScrollBar )
	S.SkinScrollBar( AchievementFrameStatsContainerScrollBar )
	S.SkinScrollBar( AchievementFrameComparisonContainerScrollBar )
	S.SkinScrollBar( AchievementFrameComparisonStatsContainerScrollBar )

	for i = 1, 3 do
		S.SkinTab( _G["AchievementFrameTab" .. i] )
	...
	for i = 1, 8 do
		...
		_G[highlight:GetName() .. "Middle"]:SetTexture( 1, 1, 1, .3 )
	...
	for i = 1, 7 do
		...
		frame.SetBackdropBorderColor = S.dummy
		...
		frame.bg1:Point( "TOPLEFT", S.mult * 4, -S.mult * 4 )
		frame.bg1:Point( "BOTTOMRIGHT", -S.mult * 4, S.mult * 4 )

		frame.bg2 = frame:CreateTexture( nil, "BACKGROUND" )
		frame.bg2:SetDrawLayer( "BACKGROUND", 3 )
		frame.bg2:SetTexture( 0, 0, 0 )
		frame.bg2:Point( "TOPLEFT", S.mult * 3, -S.mult * 3 )
		frame.bg2:Point( "BOTTOMRIGHT", -S.mult * 3, S.mult * 3 )
		...
		frame.bg3:Point( "TOPLEFT", S.mult * 2, -S.mult * 2)
		frame.bg3:Point( "BOTTOMRIGHT", -S.mult * 2, S.mult * 2 )

		frame.bg4 = frame:CreateTexture( nil, "BACKGROUND" )
		frame.bg4:SetDrawLayer( "BACKGROUND", 1 )
		frame.bg4:SetTexture( 0, 0, 0 )
		frame.bg4:Point( "TOPLEFT", S.mult, -S.mult )
		frame.bg4:Point( "BOTTOMRIGHT", -S.mult, S.mult )

		_G["AchievementFrameAchievementsContainerButton" .. i .. "Description"]:SetTextColor( 0.6, 0.6, 0.6 )
		_G["AchievementFrameAchievementsContainerButton" .. i .. "Description"].SetTextColor = S.dummy
		_G["AchievementFrameAchievementsContainerButton" .. i .. "HiddenDescription"]:SetTextColor( 1, 1, 1 )
		_G["AchievementFrameAchievementsContainerButton" .. i .. "HiddenDescription"].SetTextColor = S.dummy
		...
		_G["AchievementFrameAchievementsContainerButton" .. i .. "Tracked"].ClearAllPoints = S.dummy
		_G["AchievementFrameAchievementsContainerButton" .. i .. "Tracked"].SetPoint = S.dummy
	end
	...
	for _, compare in pairs( compares ) do
		for i = 1, 9 do
			...
			_G[frame].SetBackdropBorderColor = S.dummy

			if( _G[frame.."Description"] ) then
				_G[frame.."Description"]:SetTextColor( 0.6, 0.6, 0.6 )
				_G[frame.."Description"].SetTextColor = S.dummy
			end
			...
			_G[frame].bg1:Point( "TOPLEFT", S.mult * 4, -S.mult * 4 )
			_G[frame].bg1:Point( "BOTTOMRIGHT", -S.mult * 4, S.mult * 4 )

			_G[frame].bg2 = _G[frame]:CreateTexture( nil, "BACKGROUND" )
			_G[frame].bg2:SetDrawLayer( "BACKGROUND", 3 )
			_G[frame].bg2:SetTexture( 0, 0, 0 )
			_G[frame].bg2:Point( "TOPLEFT", S.mult * 3, -S.mult * 3 )
			_G[frame].bg2:Point( "BOTTOMRIGHT", -S.mult * 3, S.mult * 3 )
			...
			_G[frame].bg3:Point( "TOPLEFT", S.mult * 2, -S.mult * 2 )
			_G[frame].bg3:Point( "BOTTOMRIGHT", -S.mult * 2, S.mult * 2 )

			_G[frame].bg4 = _G[frame]:CreateTexture( nil, "BACKGROUND" )
			_G[frame].bg4:SetDrawLayer( "BACKGROUND", 1 )
			_G[frame].bg4:SetTexture( 0, 0, 0 )
			_G[frame].bg4:Point( "TOPLEFT", S.mult, -S.mult )
			_G[frame].bg4:Point( "BOTTOMRIGHT", -S.mult, S.mult )
	...
	hooksecurefunc( "AchievementButton_GetProgressBar", function( index )
		...
		if( frame ) then
			if not frame.skinned then
				...
				frame.bg1:Point( "TOPLEFT", -S.mult * 3, S.mult * 3 )
				frame.bg1:Point( "BOTTOMRIGHT", S.mult * 3, -S.mult * 3 )

				frame.bg2 = frame:CreateTexture( nil, "BACKGROUND" )
				frame.bg2:SetDrawLayer( "BACKGROUND", -6 )
				frame.bg2:SetTexture( unpack( C["media"].bordercolor ) )
				frame.bg2:Point( "TOPLEFT", -S.mult * 2, S.mult * 2 )
				frame.bg2:Point( "BOTTOMRIGHT", S.mult * 2, -S.mult * 2 )

				frame.bg3 = frame:CreateTexture( nil, "BACKGROUND" )
				frame.bg3:SetDrawLayer( "BACKGROUND", -5 )
				frame.bg3:SetTexture( unpack( C["media"].backdropcolor ) )
				frame.bg3:Point( "TOPLEFT", -S.mult, S.mult )
				frame.bg3:Point( "BOTTOMRIGHT", S.mult, -S.mult )
				...
				if( index > 1 ) then
					...
					frame.SetPoint = S.dummy
					frame.ClearAllPoints = S.dummy
				end
...
S.SkinFuncs["Blizzard_AchievementUI"] = LoadSkin