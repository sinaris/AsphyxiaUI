...
title:SetFont( C["media"].pixelfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE" )
...
addon:Width( 256 )
addon:Height( 64 )
addon:SetBackdropColor( unpack( C["media"].backdropcolor ) )
addon:SetClampedToScreen( true )
addon:SetClampRectInsets( 0, 0, S.Scale( 14 ), 0 )
addon:SetHitRectInsets( 0, 0, S.Scale( -14 ), 0 )
