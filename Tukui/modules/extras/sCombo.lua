...
if not C.sCombo.enable or not C["unitframes"].enable == true then return end
...
local Options = {
	comboWidth = S.Scale( 40 ),
	comboHeight = S.Scale( 11 ),
	spacing = S.Scale( 3 ),
	colors = {
		[1] = { 0.60, 0, 0, 1 },
		[2] = { 0.60, 0.30, 0, 1 },
...
Anchor.text:SetText(S.RGBToHex( unpack( C["media"].datatextcolor2 ) ).."Move CP-Bar (sCombo)")
