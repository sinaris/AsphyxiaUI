...
addonHeader.Text = S.SetFontString( addonHeader, font, fontsize, fontstyle )
...
saveButton.Text = S.SetFontString( saveButton, font, fontsize, fontstyle )
...
closeButton.Text = S.SetFontString( closeButton, font, fontsize, fontstyle )
...
raid_addons.Text = S.SetFontString( raid_addons, font, fontsize, fontstyle )
...
solo_addons.Text = S.SetFontString( solo_addons, font, fontsize, fontstyle )
...
local function UpdateAddons()
	...
	for i, v in pairs( addons ) do
		...
		local text = S.SetFontString( button, font, fontsize, fontstyle )
