...
local donor = CreateFrame( "Button", "TukuiAsphyxiaHelpFrame", ahelp )
donor:SetSize( 200, 335 )
donor:SetPoint( "TOPLEFT", ahelp, "TOPRIGHT", 8, 0 )
donor:SetTemplate( "Transparent" )
donor:CreateShadow( "Default" )
donor:FontString( "Text", C["media"].font, 13 )
donor.Text:SetPoint( "TOP", 0, -8 )
donor.Text:SetText( "|cff00AAFFAsphyxiaUI - Donors:|r\n\nMastamage\nYoeri Rousseaux\n" )
