...
if( S.client == "frFR" ) then
	...
	L.merchant_repair_guild = "Votre équipement a été réparé avec l'argent de la banque de guilde pour:"
	L.merchant_repair_personal = "Votre équipement a été réparé pour:"
