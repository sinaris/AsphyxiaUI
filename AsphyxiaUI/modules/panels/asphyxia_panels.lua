...
if( C["chat"].background == true ) then
	...
	swl.Text:SetText( S.datacolor .. "switch layout" )
...
verbutton.Text:SetText( S.datacolor .. "V" )
...
helpbutton.Text:SetText( S.datacolor .. "H" )
...
resetuibutton.Text:SetText( S.datacolor .. "RS" )
...
rluibutton.Text:SetText( S.datacolor .. "RL" )
...
mToggle:SetScript( "OnMouseDown", function()
    if( TukuiMinimap:IsVisible() ) then
		...
		TukuiAurasPlayerBuffs:Point( "TOPRIGHT", -18, -8 )
