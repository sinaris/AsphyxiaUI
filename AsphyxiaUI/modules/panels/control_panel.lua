...
abHeader.Text = S.SetFontString( abHeader, C["media"].pixelfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE" )
abHeader.Text:Point( "CENTER", abHeader, "CENTER", 0, 1 )
abHeader.Text:SetText( S.datacolor .. "Actionbar Config Menu" )
...
extraHeader.Text = S.SetFontString( extraHeader, C["media"].pixelfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE" )
extraHeader.Text:Point( "CENTER", extraHeader, "CENTER", 0, 1 )
extraHeader.Text:SetText( S.datacolor .. "Control Panel Menu" )
...
closeAB.Text = S.SetFontString( closeAB, C["media"].pixelfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE" )
closeAB.Text:Point( "CENTER", closeAB, "CENTER", 0, 1 )
closeAB.Text:SetText( S.datacolor .. "Close" )
...
---------------------------------------------------------------------------------------------
local texts = {
	[1] = { S.datacolor .. "Actionbar Config" },
	[2] = { S.datacolor .. "Addons" },
	[3] = { S.datacolor .. "Config UI" },
	[4] = { S.datacolor .. "Move UI" },
}
...
for i = 1, getn( buttons ) do
	...
	button[i].Text = S.SetFontString( button[i], C["media"].pixelfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE" )
...
close.Text = S.SetFontString( close, C["media"].pixelfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE" )
close.Text:Point( "CENTER", close, "CENTER", 0, 1 )
close.Text:SetText( S.datacolor .. "Close" )
...
extraToggle.Text = S.SetFontString( extraToggle, C["media"].pixelfont, C["datatext"].fontsize, "MONOCHROMEOUTLINE" )
extraToggle.Text:Point( "CENTER", extraToggle, "CENTER", 0, 1 )
extraToggle.Text:SetText( S.datacolor .. "Control Panel" )
