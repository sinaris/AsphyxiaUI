...
if not IsAddOnLoaded( "Recount" ) or not C["Addon_Skins"].Recount == true then return end
...
local function SkinFrame( frame )
	...
	frame.CloseButton.t:SetText( S.datacolor .. "X" )
end
...
Recount.MainWindow.RightButton.text:SetText( S.datacolor .. ">" )
...
Recount.MainWindow.LeftButton.text:SetText( S.datacolor .. "<" )
...
Recount.MainWindow.ResetButton.text:SetText( S.datacolor .. "R" )
...
Recount.MainWindow.FileButton.text:SetText( S.datacolor .. "F" )
...
Recount.MainWindow.ConfigButton.text:SetText( S.datacolor .. "C" )
...
Recount.MainWindow.ReportButton.text:SetText( S.datacolor .. "S" )
