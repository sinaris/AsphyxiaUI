...
if not IsAddOnLoaded( "Skada" ) or not C["Addon_Skins"].Skada == true then return end
...
function EmbedSkada()
	...
	elseif( #windows == 2 ) then
		EmbedWindow( windows[1], ( ( TukuiChatBackgroundRight:GetWidth() - 4 ) / 2 ) - ( borderWidth + S.mult ), ( TukuiChatBackgroundRight:GetHeight() - 4 - ( barSpacing * 4 ) ) / 10, TukuiChatBackgroundRight:GetHeight() - 4, "BOTTOMRIGHT", TukuiChatBackgroundRight, "BOTTOMRIGHT", -2, 3 )
		EmbedWindow( windows[2], ( ( TukuiChatBackgroundRight:GetWidth() - 4 ) / 2 ) - ( borderWidth + S.mult ), ( TukuiChatBackgroundRight:GetHeight() - 4 - ( barSpacing * 4 ) ) / 10, TukuiChatBackgroundRight:GetHeight() - 4, "BOTTOMLEFT", TukuiChatBackgroundRight, "BOTTOMLEFT", 2, 3 )
	elseif( #windows > 2 ) then
		EmbedWindow( windows[1], ( ( TukuiChatBackgroundRight:GetWidth() - 4 ) / 2 ) - ( borderWidth + S.mult ), ( TukuiChatBackgroundRight:GetHeight() - 4 - ( barSpacing * 4 ) ) / 10, TukuiChatBackgroundRight:GetHeight() - 4, "BOTTOMRIGHT", TukuiChatBackgroundRight, "BOTTOMRIGHT", -2, 3 )
		EmbedWindow( windows[2], ( ( TukuiChatBackgroundRight:GetWidth() - 4 ) / 2 ) - ( borderWidth + S.mult ), ( ( TukuiChatBackgroundRight:GetHeight() - 6 / 2 ) - ( barSpacing * 4 ) ) / 10, TukuiChatBackgroundRight:GetHeight() - 4 / 2 - 2,  "BOTTOMLEFT", TukuiChatBackgroundRight, "BOTTOMLEFT", 2, 3 )
...
if( C["Addon_Skins"].embedright == "Skada" ) then
	...
	if( TukuiTabsRightBackground ) then
		...
		button.tex:SetTexture( [[Interface\AddOns\AsphyxiaUI\medias\textures\addons_toggle.tga]] )
